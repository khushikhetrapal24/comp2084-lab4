namespace NewMobileApplication.Migrations
{
    using NewMobileApplication.Models;
    using System;
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<NewMobileApplication.Models.DataContext>
    {
        ...
        protected override void Seed(NewMobileApplication.Models.DataContext context)
        {
